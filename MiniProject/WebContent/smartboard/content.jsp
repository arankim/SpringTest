	...
	<tr>
		<td colspan="2" align="right">
			<input type="button" class="btn btn-default btn-xs"
			  ...
			  onclick="location.href='layoutsero.jsp?main=smartboard/smartboard.jsp'">
			<input type="button" class="btn btn-default btn-xs"
			  value="글목록" style="width: 60px;"
			  onclick="location.href='layoutsero.jsp?main=smartboard/smartpagelist.jsp?pageNum=<%=pageNum%>'">			
		</td>
	</tr>	
</table>
</body>
